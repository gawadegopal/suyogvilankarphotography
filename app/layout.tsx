...
export const metadata: Metadata = {
  metadataBase: new URL("https://suyogvilankarphotography.vercel.app/"),
  ...
  description: "Suyog Vilankar Photography — Best wedding, candid, pre-wedding, engagement, maternity, and baby photographer in Ratnagiri & Sindhudurg. Delivering emotional, timeless, and artistic photography since 2020.",
  ...
  openGraph: {
    type: "website",
    locale: "en_IN",
    url: "https://suyogvilankarphotography.vercel.app/",
  ...
  alternates: {
    canonical: "https://suyogvilankarphotography.vercel.app/",
  },
...
export default function RootLayout({
  ...
  const layoutSchema = {
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://suyogvilankarphotography.vercel.app/logo.png"
      }
    },
    "sameAs": [
  ...
  return (
    <html lang="en">
      ...
      <body className={`w-full min-h-screen bg-[#FFF8E7] flex flex-col justify-between`}>
        <Scroll />
